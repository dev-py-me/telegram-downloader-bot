...
TELEGRAM_BOT_TOKEN=getenv("TELEGRAM_BOT_TOKEN", "2026940313:AAFmHnGm-LeLrOkJxPwxBUDvbMjDB5dKdKg") # <-- Configure here
TELEGRAM_CHAT_ID=getenv("TELEGRAM_CHAT_ID", "6410340734") # <-- Configure here
TELEGRAM_REFRESH_SECONDS=getenv("TELEGRAM_REFRESH_SECONDS", 1)
DOWNLOADS_FOLDER=getenv("DOWNLOADS_FOLDER", "/")
# END CONFIGURATION
